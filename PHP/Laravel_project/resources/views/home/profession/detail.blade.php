            ...
            <div class="bigpic-title">
                ...
                <div class="bigpic-body"><span class="bigpic-body-title"><span class="bigpic-body-title-nav">{{$data -> pro_name}}</span></span><span id="d_clip_button" class="shareCourse" data-clipboard-target="fe_text">分享课程，赚取学费<em>&gt;&gt;</em></span>
                    ...
                    <p class="bigpic-body-list">
                        <span class="body-list-right">主讲：汪老师、邹老师</span>
                        <span class="body-list-right myTimes" title="课程时长" style="cursor:default">学习时长：{{$data -> duration}}小时</span>
                        <span title="学习人数" style="cursor:default">学习人数：{{$data -> view_count}}人已学习</span>
                        <span title="有效期" style="cursor:default;color:#333;" class="youxiaoqi">有效期：1年<span class="yibaoming" style="display:none"><img src="/home/css/baoming.png"></span></span>
                    </p>
