            ...
            <tbody>
                ...
                <tr class="text-c">
                    ...
                    <td class="f-14">
                    	...
                    	<!-- 分派权限代码 -->
                    	<a title="分派权限" href="javascript:;" onclick="admin_role_assign('角色权限分派','/admin/role/assign','{{$val ->  id}}')" style="text-decoration:none"><i class="Hui-iconfont">&#xe654;</i></a>
                    	<!-- 分派权限代码 -->
