...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li>{{Auth::guard('diy_admin')->user()->rel_role->role_name}}</li>
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A">{{Auth::guard('diy_admin')->user()->username}}<i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="product-list.html" data-title="答题卡管理" href="javascript:void(0)">答题卡管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-comments">
